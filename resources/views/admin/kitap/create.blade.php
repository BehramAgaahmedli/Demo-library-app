                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">Kitab Əlavə Et</h4>
                            <p class="category">Kitab Oluşturunuz</p>
                        </div>
                        <div class="card-content">
                            <form enctype="multipart/form-data" action="{{route('admin.kitap.create.post')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label">Kitab Açıklama</label>
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Kitab Əlavə Et</button>
