            ...
            <div class="single-main">
                <div class="col-md-12 single-main-left">
                    <div class="sngl-top">
                        ...
                        <div class="col-md-9 single-top-right">
                            <div class="single-para simpleCart_shelfItem">
                                ...
                                <h5 class="item_price">{{$data[0]['fiyat']}} AZN</h5>
                                <p>{{$data[0]['aciklama']}}</p>
                                ...
                                <a href="{{route('basket.add',['id'=>$data[0]['id']])}}" class="add-cart item_add">SƏBƏTƏ ƏLAVƏ ET</a>
                    ...
                    <div class="latestproducts">
                        ...
                        @foreach(\App\Models\Kitablar::inRandomOrder()->limit(3)->get() as $key => $value)
                            <div class="col-md-4 product-left p-left">
                                <div class="product-main simpleCart_shelfItem">
                                    ...
                                    <div class="product-bottom">
                                        ...
                                        <h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">{{$value['fiyat']}} Azn</span></h4>
                                    </div>
                                </div>
                            </div>
                            @endforeach
